...
final class Version20260228142418 extends AbstractMigration
{
    ...
    {
        return 'Add event scope/visibility, FFTA public event fields, and club geographic fields';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD scope ENUM(\'club\', \'departmental\', \'regional\', \'national\') DEFAULT \'club\' NOT NULL, ADD ffta_event_id INT DEFAULT NULL, ADD ffta_comite_departemental VARCHAR(255) DEFAULT NULL, ADD ffta_comite_regional VARCHAR(255) DEFAULT NULL');
