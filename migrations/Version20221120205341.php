...
final class Version20221120205341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD latitude VARCHAR(16) DEFAULT NULL, ADD longitude VARCHAR(16) DEFAULT NULL, ADD all_day TINYINT(1) NOT NULL, ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
