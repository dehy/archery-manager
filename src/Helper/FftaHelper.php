...
class FftaHelper
{
     ...
     * @throws \Exception
     */
    public function syncLicenseeWithId(Club $club, string $fftaId, int $season = null): Licensee
    {
        $scrapper = $this->getScrapper($club);
        ...
        $fftaProfile = $scrapper->fetchLicenseeProfile($fftaId);
        ...
        $this->syncLicensesForLicensee($club, $licensee, $season);
     ...
     * @throws \Exception
     */
    public function syncLicensesForLicensee(Club $club, Licensee $licensee, ?int $season = null): array
    {
