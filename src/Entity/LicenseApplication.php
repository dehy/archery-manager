...
#[ORM\Entity(repositoryClass: LicenseApplicationRepository::class)]
#[UniqueEntity(
...
class LicenseApplication
{
    ...
    #[ORM\Column(type: 'LicenseApplicationStatusType')]
    #[DoctrineAssert\EnumType(entity: LicenseApplicationStatusType::class)]
    private string $status = LicenseApplicationStatusType::PENDING;
